    ...
    <script>
        ...
        function makeCharts(votes, reviews, leads) {
            ...
            //altrimenti l'ordine è quello reale
                ...
                monthsLabels = ['Gennaio', 'Febbraio', 'Marzo', 'Aprile', 'Maggio', 'Giugno', 'Luglio', 'Agosto',
            ...
            myChartReviewsMessages = new Chart(ChartReviewsMessages, {
                ...
                data: {
                    ...
                    datasets: [{
                            ...
                            borderWidth: 3,
                            hoverBorderWidth: 2,
                            backgroundColor: 'rgba(0, 220, 182, 0.6)',
                            borderColor: 'rgba(0, 220, 182, 1)',
                            tension: 0.1
                        },
                        {
                            ...
                            borderWidth: 3,
                            hoverBorderWidth: 2,
                            backgroundColor: 'rgba(255, 28, 65, 0.6)',
                            borderColor: 'rgba(255, 28, 65, 1)',
                            tension: 0.4
                        }
                    ]
                },
