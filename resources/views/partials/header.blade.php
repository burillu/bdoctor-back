        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{-- {{route('admin.profile.index')}} --}}">{{ __('Profilo') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{-- {{ route('admin.leads.index') }} --}}">{{ __('Messaggi') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{-- {{route('admin.reviews.index')}} --}}">{{ __('Recensioni') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{-- {{route('admin.sponsorship.index')}} --}}">{{ __('Sponsorizzazioni') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{-- {{route('admin.stats.index')}} --}}">{{ __('Statistiche') }}</a>
                    </li>
                </ul>
